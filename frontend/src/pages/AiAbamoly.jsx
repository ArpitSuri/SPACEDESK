...
//             const endpoint =
//                 dataMode === 'sample'
//                     ? 'http://localhost:3000/api/telemetry/next'
//                     : 'http://localhost:3000/api/telemetry';

//             const method = dataMode === 'sample' ? 'post' : 'get';

//             const response = await axios({ method, url: endpoint });
...
//         try {
//             const response = await axios.get('http://localhost:3000/api/telemetry/analyze');
//             const data = response.data;
//             setAnalysis(data.analysis);

//             if (data.analysis?.isAnomaly) {
//                 const currentAnomalyKey = `${data.reading.power}-${data.analysis.zScore}`;
...
//                     toast.error(
//                         `🚨 Anomaly Detected! Power: ${data.reading.power}W (Z-score: ${data.analysis.zScore})`,
//                         {
//                             position: 'top-right',
//                             autoClose: 5000,
...
//                 }
//             } else {
//                 setLastAnomalyKey(null); // reset on normal reading
//             }
//         } catch (error) {
...
//         try {
//             await axios.post('http://localhost:3000/api/telemetry/start-simulation');
...
//     }, [isMonitoring, dataMode]);

//     const chartData = telemetry?.history
//         ? {
//             labels: telemetry.history.map((_, i) => i),
//             datasets: [
//                 {
//                     label: 'Power (W)',
//                     data: telemetry.history.map((d) => d.power),
//                     borderColor: 'rgb(75, 192, 192)',
//                     backgroundColor: 'rgba(75,192,192,0.2)',
//                     tension: 0.3,
//                     pointRadius: 3,
//                     pointBackgroundColor: telemetry.history.map((_, i) =>
//                         analysis?.isAnomaly && i === telemetry.history.length - 1
//                             ? 'rgb(255, 99, 132)'
//                             : 'rgb(75, 192, 192)'
//                     ),
//                 },
...
//             y: { title: { display: true, text: 'Power (W)' }, beginAtZero: false },
//         },
//     };

//     return (
//         <div className="max-w-6xl mx-auto p-6 bg-gray-100 font-sans min-h-screen">
//             <header className="flex justify-between items-center border-b pb-5 mb-6">
//                 <h1 className="text-2xl font-bold text-gray-800">Satellite Telemetry Monitor</h1>
...
//                         className={`px-4 py-2 rounded text-white text-sm transition ${isMonitoring ? 'bg-red-500' : 'bg-green-600'
//                             }`}
//                     >
...
//                                 <span>{telemetry.current.power} W</span>
//                             </div>
//                             <div className="flex justify-between">
//                                 <span className="font-medium text-gray-600">Voltage:</span>
//                                 <span>{telemetry.current.voltage} V</span>
//                             </div>
//                             <div className="flex justify-between">
//                                 <span className="font-medium text-gray-600">Temperature:</span>
//                                 <span>{telemetry.current.temperature} °C</span>
//                             </div>
...
//                 <div>
//                     <h2 className="text-lg font-semibold mb-3">Anomaly Analysis</h2>
//                     {analysis ? (
//                         <div
//                             className={`bg-white rounded shadow p-4 space-y-2 border-l-4 ${analysis.isAnomaly ? 'border-red-500 animate-pulse' : 'border-green-500'
//                                 }`}
//                         >
//                             <div className="flex justify-between">
//                                 <span className="font-medium text-gray-600">Status:</span>
//                                 <span>{analysis.isAnomaly ? 'ANOMALY DETECTED' : 'Normal Operation'}</span>
//                             </div>
//                             <div className="flex justify-between">
//                                 <span className="font-medium text-gray-600">Z-Score:</span>
//                                 <span>{analysis.zScore || 'N/A'}</span>
//                             </div>
//                             <div className="flex justify-between">
//                                 <span className="font-medium text-gray-600">Moving Avg:</span>
//                                 <span>{analysis.movingAvg || 'N/A'} W</span>
//                             </div>
//                             <div className="flex justify-between">
//                                 <span className="font-medium text-gray-600">Deviation:</span>
//                                 <span>{analysis.deviation || 'N/A'}</span>
//                             </div>
//                         </div>
//                     ) : (
//                         <p>Run analysis to detect anomalies</p>
//                     )}
//                 </div>
//             </div>

//             <div className="bg-white rounded shadow p-4 mb-6">
//                 {telemetry?.history && <Line data={chartData} options={chartOptions} />}
//             </div>
...
//                                 <th className="p-2 border-b text-left">Power (W)</th>
//                                 <th className="p-2 border-b text-left">Z-Score</th>
//                                 <th className="p-2 border-b text-left">Deviation</th>
//                             </tr>
//                         </thead>
//                         <tbody>
//                             {anomalyHistory.map((anomaly) => (
//                                 <tr key={anomaly.id} className="hover:bg-gray-50">
//                                     <td className="p-2 border-b">{anomaly.timestamp}</td>
//                                     <td className="p-2 border-b">{anomaly.power}</td>
//                                     <td className="p-2 border-b">{anomaly.zScore}</td>
//                                     <td className="p-2 border-b">{anomaly.deviation}</td>
//                                 </tr>
//                             ))}
//                         </tbody>
//                     </table>
