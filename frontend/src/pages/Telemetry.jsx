...
// const chartConfigs = [
//     { id: "altitudeChart", label: "Altitude", color: "#66fcf1", unit: "km" },
//     { id: "velocityChart", label: "Velocity", color: "#f1c40f", unit: "km/s" },
//     { id: "powerChart", label: "Power Level", color: "#e74c3c", unit: "%" },
//     { id: "tempChart", label: "Temperature", color: "#3498db", unit: "°C" },
//     { id: "fuelChart", label: "Fuel Level", color: "#9b59b6", unit: "%" },
//     { id: "orientationChart", label: "Orientation", color: "#2ecc71", unit: "°" },
// ];

// const getSimulatedData = () => ({
//     altitude: (400 + Math.random() * 10).toFixed(2), // ~400 km
//     velocity: (7.66 + Math.random() * 0.2).toFixed(2), // ~7.66 km/s
