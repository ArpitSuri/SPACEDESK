...
//         status: "Completed",
//         timeline: [
//             { stage: "Launch", time: "1969-07-16T13:32:00Z" },
//             { stage: "Lunar Orbit Insertion", time: "1969-07-19T17:21:00Z" },
//             { stage: "Moon Landing", time: "1969-07-20T20:17:00Z" },
//             { stage: "Earth Return", time: "1969-07-24T16:50:00Z" }
//         ]
//     },
//     {
//         id: 2,
...
//         status: "Active",
//         timeline: [
//             { stage: "Launch", time: "2020-07-30T11:50:00Z" },
//             { stage: "Mars Landing", time: "2021-02-18T20:55:00Z" },
//             { stage: "Rover Deployment", time: "2021-03-04T00:00:00Z" }
//         ]
//     },
//     // ... Add 10 more missions here similar to the above
// ];

// const MissionCard = ({ mission, onClick }) => (
//     <div
//         className="border rounded-lg p-4 shadow-md cursor-pointer hover:shadow-lg transition-all"
//         onClick={() => onClick(mission)}
//     >
//         <h2 className="text-lg font-semibold">{mission.name}</h2>
//         <p className="text-sm">Agency: {mission.agency}</p>
...
//             <p className="text-sm">Agency: {mission.agency}</p>
//             <p className="text-sm mb-4">Status: {mission.status}</p>
//             <ul className="space-y-2">
//                 {mission.timeline.map((event, index) => (
//                     <li key={index} className="text-sm">
//                         <strong>{event.stage}</strong>: {new Date(event.time).toLocaleString()}
//                     </li>
//                 ))}
//             </ul>
//             <button
...
//     return (
//         <div className="p-4">
//             <h1 className="text-2xl font-bold mb-4">Mission Dashboard</h1>
//             <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
//                 {missions.map((mission) => (
//                     <MissionCard key={mission.id} mission={mission} onClick={setSelectedMission} />
//                 ))}
//             </div>
//             {selectedMission && (
